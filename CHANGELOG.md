...
- Fix problem when deleting group
- Fixed error handling on delete group request 
...
- Increased page size in Account Linking
...
- Removed Breadcrumbs where they are not needed
- Replaces Keycloak Logo with RCIAM
...
- Fix problem deleting a group that includes membership [RCIAM-542](https://tts.grnet.gr/jira/browse/RCIAM-542)
- take into account possible null first or last name
