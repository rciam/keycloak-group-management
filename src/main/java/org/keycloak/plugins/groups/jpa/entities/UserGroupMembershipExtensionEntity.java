...
@NamedQueries({
        ...
        @NamedQuery(name="getSoonExpiredMemberships", query="from UserGroupMembershipExtensionEntity f where f.status = :status and (f.membershipExpiresAt < :date or f.aupExpiresAt < :date)"),
